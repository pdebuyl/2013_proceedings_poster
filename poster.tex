...
\begin{itemize}
\item Fork \url{https://github.com/euroscipy/euroscipy_proceedings}
\item Clone the fork: 
  \begin{itemize}
    \item \texttt{git clone git@github.com:GITHUB\_LOGIN/euroscipy\_proceedings}

  \end{itemize}
\item Write your paper in \texttt{papers/lastname.rst}
\item Commit and push it:
  \begin{itemize}
  \item \texttt{git add papers/lastname.rst}
